...
'''
https://viblo.asia/p/python-args-va-kwargs-gDVK2pdnlLj
...
def test_divide_scalar_backward():
    gradient_check(ndl.divide_scalar, ndl.Tensor(np.random.randn(5, 4)),
...
def test_summation_backward():
    ...
    gradient_check(ndl.summation, ndl.Tensor(np.random.randn(5,4,1)), axes=(0,2))
    gradient_check(ndl.summation, ndl.Tensor(np.random.randn(5,4,1)), axes=(1,2))
    gradient_check(ndl.summation, ndl.Tensor(np.random.randn(5,4,2,1,3)), axes=(1,3))
    # 
