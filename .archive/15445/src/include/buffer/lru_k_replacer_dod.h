...
class LRUKReplacer {
 ...
 private:
  ...
  // Thay frame_entries_ array thành multiple list arrays
  std::bitset<32000> is_active_;
  std::bitset<32000> evictable_;
  uint16_t *hits_count_;
  std::list<frame_id_t>::iterator *pos_;
  // END frame_entries_ multiple list arrays
