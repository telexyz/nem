...
class WKV(torch.autograd.Function):
    ...
    def forward(ctx, B, T, C, w, u, k, v):
        ...
        RWKV_FLOAT_MODE = os.environ['RWKV_FLOAT_MODE']
        is_mode_float32 = ('32' in RWKV_FLOAT_MODE)
        ...
        if is_mode_float32:
            ...
            return y.bfloat16()
        # else: should throw exception here
    ...
    def backward(ctx, gy):
        ...
        if is_mode_float32:
            ...
            return (None, None, None, 
                gw.half(), gu.half(), gk.half(), gv.half())

        elif RWKV_FLOAT_MODE == 'bf16':
            return (None, None, None, 
                gw.bfloat16(), gu.bfloat16(), gk.bfloat16(), gv.bfloat16())
